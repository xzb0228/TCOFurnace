...
namespace TCOFurnace.Forms
{
	public class FormHandMode : BaseForm
	{
		...
		private void OperWriteReg1_1(bool isOpen)
		{
			if (isOpen)
			{
				...
				if (int.TryParse(textWriteReg1_1.Text, out int val) || val < 0 || val > 20)
				{
					...
					GlobalPara.deviceProtocol.AddMainQueue(Smess.WriteReg1_1);
				}
				else
				{
		...
		private void OperWriteReg1_2(bool isOpen)
		{
			if (isOpen)
			{
				...
				if (int.TryParse(textWriteReg1_2.Text, out int val) || val < 0 || val > 20)
				{
					...
					GlobalPara.deviceProtocol.AddMainQueue(Smess.WriteReg1_2);
				}
				else
				{
					MessageBox.Show("输入的数据不正确(0-20)");
			...
			if (toggle != null)
			{
				...
				if (toggle.IsOn)
				{
					...
					if (int.TryParse(textWriteReg1_5.Text, out int val) || val < 0 || val > 20)
					{
						...
						GlobalPara.deviceProtocol.AddMainQueue(Smess.WriteReg1_5);
					}
					else
					{
						MessageBox.Show("输入的数据不正确(0-20)");
		...
		private void OperWriteReg2_3(bool isOpen)
		{
			if (isOpen)
			{
				...
				if (int.TryParse(textWriteReg2_3.Text, out int val) || val < 0 || val > 20)
				{
					...
					GlobalPara.deviceProtocol.AddMainQueue(Smess.WriteReg2_3);
				}
				else
				{
					MessageBox.Show("输入的数据不正确(0-20)");
		...
		private void OperWriteReg2_4(bool isOpen)
		{
			...
			{ // 开关打开时的操作
				if (int.TryParse(textWriteReg2_4.Text, out int val) || val < 0 || val > 20)
				{
					...
					GlobalPara.deviceProtocol.AddMainQueue(Smess.WriteReg2_4);
				}
				else
				{
					MessageBox.Show("输入的数据不正确(0-20)");
				...
				{ // 这里可以添加更多状态改变后的逻辑
					if (toggle.IsOn)
					{
						...
						if (int.TryParse(textWriteReg2_6.Text, out int val) || val < 0 || val > 20)
						{
							...
							GlobalPara.deviceProtocol.AddMainQueue(Smess.WriteReg2_6);
						}
						else
						{
							MessageBox.Show("输入的数据不正确(0-20)");
		...
		private void InitializeComponent()
		{
			...
			this.label13.Location = new System.Drawing.Point(207, 243);
			...
			this.label14.Location = new System.Drawing.Point(207, 298);
			...
			// textWriteReg1_1_C
			// 
			this.textWriteReg1_1_C.Location = new System.Drawing.Point(230, 239);
			...
			this.label21.Location = new System.Drawing.Point(262, 243);
			...
			this.label22.Location = new System.Drawing.Point(262, 294);
			...
			// textWriteReg1_2_C
			// 
			this.textWriteReg1_2_C.Location = new System.Drawing.Point(230, 290);
			...
			this.label23.Location = new System.Drawing.Point(579, 244);
			...
			// textWriteReg2_3_C
			// 
			this.textWriteReg2_3_C.Location = new System.Drawing.Point(547, 240);
			...
			this.label24.Location = new System.Drawing.Point(579, 294);
			...
			// textWriteReg2_4_C
			// 
			this.textWriteReg2_4_C.Location = new System.Drawing.Point(547, 290);
		...
		private void butDCF1_Click(object sender, EventArgs e)
		{
			...
			GlobalPara.deviceProtocol.AddMainQueue(Smess.WriteCoil1_1);
		...
		private void butDCF3_Click(object sender, EventArgs e)
		{
			...
			GlobalPara.deviceProtocol.AddMainQueue(Smess.WriteCoil1_2);
		...
		private void butDCF2_Click(object sender, EventArgs e)
		{
			...
			GlobalPara.deviceProtocol.AddMainQueue(Smess.WriteCoil2_3);
		...
		private void butDCF4_Click(object sender, EventArgs e)
		{
			...
			GlobalPara.deviceProtocol.AddMainQueue(Smess.WriteCoil2_4);
