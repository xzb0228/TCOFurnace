...
namespace TCOFurnace
{
    public class Smess
    {
        ...
        //调压设定
        public static CModbusReg WriteReg1_1 = new CModbusReg("1氧调压", 20, CModbusCode.WriteReg, 0, 2, new byte[2] { 0x00, 0x00 });
        public static CModbusReg WriteReg1_2 = new CModbusReg("1催调压", 20, CModbusCode.WriteReg, 1, 2, new byte[2] { 0x00, 0x00 });
        public static CModbusReg WriteReg2_3 = new CModbusReg("2氧调压", 20, CModbusCode.WriteReg, 2, 2, new byte[2] { 0x00, 0x00 });
        public static CModbusReg WriteReg2_4 = new CModbusReg("2催调压", 20, CModbusCode.WriteReg, 3, 2, new byte[2] { 0x00, 0x00 });

        //流量计设定
        public static CModbusReg WriteReg1_5 = new CModbusReg("1流量计4到20mA流量设定", 20, CModbusCode.WriteReg, 4, 2, new byte[2] { 0x00, 0x00 });
        public static CModbusReg WriteReg2_6 = new CModbusReg("2流量计4到20mA流量设定", 20, CModbusCode.WriteReg , 5, 2, new byte[2] { 0x00, 0x00 });
