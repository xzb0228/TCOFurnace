...
namespace TCOFurnace
{
    public class Smess
    {
        ...
        //2路 总共4个温度回传 1分钟采集一次数据
        public static TimesModbusReg CReadHolding1_1 = new TimesModbusReg("4路温度回传", 1, ModbusCode.ReadHolding, 8192, 4, new byte[2] { 0x00, 0x00 }, intervalMs:1000*60);
    }
}
